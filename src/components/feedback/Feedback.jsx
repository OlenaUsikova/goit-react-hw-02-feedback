...
export class Feedback extends React.Component {
  ...
  handlerGoodClick = () => {
    this.setState(prevStateGood => ({ counterGood: prevStateGood.counterGood + 1 }));
  };
  handlerNeutralClick = () => {
    ...
    return (
      <>
        ...
        <SectionStatistics>
          <StatisticField
            text="Good"
            amount={this.state.counterGood}
          ></StatisticField>
          <StatisticField
            text="Neutral"
            amount={this.state.counterNeutral}
          ></StatisticField>
          <StatisticField
            text="Bad"
            amount={this.state.counterBad}
          ></StatisticField>
        </SectionStatistics>
      </>
    );
